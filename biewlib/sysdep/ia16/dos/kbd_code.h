/**
 * @namespace   biewlib
 * @file        biewlib/sysdep/ia16/dos/kbd_code.h
 * @brief       This file contains definitions of BIOS keyboard codes.
 * @version     -
...
/* This codes describes shift keys state */
...
#define KE_CTL_ENTER         0x1C0A
#define KE_SPACE             0x3920
#define KE_BKSPACE           0x0E08
#define KE_CTL_BKSPACE       0x0E7F
#define KE_TAB               0x0F09
#define KE_SHIFT_TAB         0x0F00
...
#define KE_CTL_LEFTARROW     0x7300
#define KE_CTL_RIGHTARROW    0x7400
...
#define KE_CTL_PGDN          0x7600
#define KE_CTL_PGUP          0x8400
#define KE_CTL_HOME          0x7700
#define KE_CTL_END           0x7500
#define KE_CTL_INS           0x9200
#define KE_CTL_DEL           0x9300

#define KE_F(x)		((0x3A+(x))<<8)
#define KE_SHIFT_F(x)	((0x53+(x))<<8)
#define KE_CTL_F(x)	((0x5D+(x))<<8)
#define KE_ALT_F(x)	((0x67+(x))<<8)
