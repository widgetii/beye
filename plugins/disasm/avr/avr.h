...
/* identify instruction of return class */
#define AVR_RET_CLASS(x) ((x) == 0x9508 || (x) == 0x9518)

/* identify instruction of leave class (ex.: pop r1) */
#define AVR_LEAVE_CLASS(x) (0)

/* identify instruction of jump via virtual table */
#define AVR_JMPVVT_CLASS(x) (0)

/* identify instruction of jump via PIC */
#define AVR_JUMPPIC_CLASS(x) ((x) == 0xC000 || (x) == 0xD000)
